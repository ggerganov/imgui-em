...
void update() {
    ...
    if (show_demo_window)
    {
        ImGui::SetNextWindowPos(ImVec2(20, 50), ImGuiCond_FirstUseEver); // Normally user code doesn't need/want to call this because positions are saved in .ini file anyway. Here we just want to make the demo initial state a bit more friendly!
